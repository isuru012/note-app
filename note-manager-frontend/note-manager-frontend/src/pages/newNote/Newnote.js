    ...
    return (
        <div>
            ...
            {/*<Grid container justify="center" alignItems="center">
                <Grid item xs={12} md={6} component={Paper} elevation={3} className={classes.root}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Typography variant="body2" color="textSecondary" component="p">
                            {titleChars} / 50 characters filled
                        </Typography>
                        ...
                        <Typography variant="body2" color="textSecondary"
                                    component="p">
                            {descriptionChars} / 300 characters filled
                        </Typography>
                        ...
                        >
                            Save
                            {isLoading && <CircularProgress size={24} className={classes.loadingSpinner} />}
                        </Button>
                    </form>
                </Grid>
            </Grid>*/}
